...
const Navbar = (props) => {
    ...
    const formUrl = "https://github.com/MurageKibicho"
...
return(
    <Container>
        ...
        <LinkDiv>
          ...
          <LinksContainer onClick={Scroll1}>Articles</LinksContainer>
          <LinksContainer onClick={Scroll2}>Portfolio</LinksContainer>
          <LinksContainer onClick={() =>OpenLink(formUrl)}>GitHub</LinksContainer>
        </LinkDiv>
    </Container>
)
}
